...
=======
\usepackage{amssymb, amsmath, amsthm, mathrsfs}
>>>>>>> 6a502f06d03beb31d1cb171d032df691ebd3c839
...
\subparagraph*{Osservazione}
E' sempre possibile ricondursi al caso $x_0 = 0$ con una opportuna traslazione.

L'insieme di convergenza di \ref{seriepotenza} è l'insieme degli $x \in \mathbb{R}$ tali che \ref{seriepotenza} converge. 
\subparagraph*{Osservazione} L'insieme di convergenza di una serie di potenze è sempre un \textbf{intervallo.}
...
allora l'unica soluzione di ???MARCO??
