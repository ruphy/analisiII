...
\begin{itemize}
 \item Controlla che $\Omega$ sia misurabile, $\mathcal{E}f$ integrabile (soprattutto: limitata, monotona)
 \item Da qui puoi
 \begin{itemize}
  \item Cercare un insieme semplice $D$, e trasformare $\Omega$ in $D$ tramite un diffeomorfismo
  \begin{itemize}
   \item ...
  \end{itemize}
  \item Integrare sull'insieme $\Omega$
  \begin{itemize}
   \item ...
  \end{itemize}
 \end{itemize}
