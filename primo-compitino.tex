...
blablae $\Phi$ biunivoca ?<testo incomprensibile di edo>? Allora $\Phi$ è un diffeomorfismo globale se $\Phi \in \mathbb{C}^1(\Omega^\circ)$, e
...
\begin{itemize}
 ...
 \begin{itemize}
  ...
  \begin{itemize}
   ...
   \item Allora: $$\int_\Omega f = \lim_{R \to +\infty} \int_{B_R} \mathcal{E}f_+ - \int_{B_R} \mathcal{E}f_- $$
  \end{itemize}
